...
**Flagship Repository**:
The public Git repository hosting the verified source code, architecture specifications, and test harnesses for a Flagship Project.
_Avoid_: Repo link, code link, github page, project repo
